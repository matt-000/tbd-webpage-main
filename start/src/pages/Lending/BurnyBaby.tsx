...
const App: React.FC<AddressProps> = (props) => {
  return (
    <div>
		...
		<InteractionsClaim contract={props.contract} user_address={props.user_address} provider={props.provider} signer={props.signer} fetti_address={props.fetti_address} stringEpochPlaced={props.stringEpochPlaced} stringCurrentEpoch={props.stringCurrentEpoch} stringDaiToSend={props.stringDaiToSend} stringLiqToBurn={props.stringLiqToBurn} updateBalance={props.updateBalance}/>
	</div>
  );
};
